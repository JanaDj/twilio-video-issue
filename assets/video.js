window.addEventListener("load", () => {
  ...
  function startVideoChat(room, token) {
    ...
    Twilio.Video.connect(token, {
      ...
      document.getElementById('pause-video').onclick = function() {
        pauseVideo(room.localParticipant)
      }
  
      document.getElementById('start-video').onclick = function() {
        unpauseVideo(room.localParticipant)
      }
    });
  }

  function pauseVideo(participant) {
